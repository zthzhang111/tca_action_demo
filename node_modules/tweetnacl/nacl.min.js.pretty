! function(r) {
    ...
    function l(r, n, e, t, o, i, a) {
        ...
        if (o > 0)
            for (w(y, c, a, Br), u = 0; u < o; u++) r[n + u] = (e ? e[t + u] : 0) ^ y[u];
        return 0
    }
    ...
    function b(r, n, e, t, o, i) {
        var a, f, u, c, w = new Uint32Array(17),
        ...
        for (y[3] &= 15, y[4] &= 252, y[7] &= 15, y[8] &= 252, y[11] &= 15, y[12] &= 252, y[15] &= 15; o > 0;) {
            ...
            for (s[u] = 1, t += u, o -= u, v(l, s), f = 0; f < 17; f++)
                for (w[f] = 0, u = 0; u < 17; u++) w[f] = w[f] + l[u] * (u <= f ? y[f - u] : 320 * y[f + 17 - u] | 0) | 0 | 0;
    ...
    function J(r, n, e) {
        ...
        for (var l = 0; e >= 128;) {
            ...
            for (a = 0; a < 80; a++) {
                ...
                if (a % 16 === 15)
                    for (f = 0; f < 16; f++) y[f] = M(y[f], y[(f + 9) % 16], D(y[(f + 1) % 16]), H(y[(f + 14) % 16]))
            }
    ...
    r.lowlevel = {
            ...
            var t, o = new Uint8Array(Ir + r.length),
